...
function Documentation(props: Props) {
    ...
    <header>
      <nav
        className="js-navbar-scroll navbar navbar-expand-md navbar-dark td-navbar"
      >
          ...
          <ul className="navbar-nav ml-auto pt-4 pt-md-0 my-2 my-md-1">
            <li className="nav-item mr-2 mr-lg-4 mt-1 mt-lg-0">
              <Link className="nav-link" to="/docs/"
                ><i className="fas fa-book pr-2"></i><span>Documentation</span></Link
              >
            </li>
            <li className="nav-item mr-2 mr-lg-4 mt-1 mt-lg-0">
              <Link
                ...
                target="_blank"
                ><i className="fas fa-rss pr-2"></i><span>Blog</span></Link
              >
            </li>
            <li className="nav-item mr-2 mr-lg-4 mt-1 mt-lg-0">
              <Link
                ...
                target="_blank"
                ><i className="fab fa-github pr-2"></i><span>GitHub</span></Link
              >
            </li>
            <li className="nav-item dropdown mt-1 mt-lg-0 mr-2">
              ...
              >
                <Link className="dropdown-item" to="https://master.kubeflow.org"
                  >master</Link
                >
                <Link className="dropdown-item" to="https://v1-5-branch.kubeflow.org"
                  >v1.5</Link
                >
                <Link className="dropdown-item" to="https://v1-4-branch.kubeflow.org"
                  >v1.4</Link
                >
                <Link className="dropdown-item" to="https://v1-3-branch.kubeflow.org"
                  >v1.3</Link
                >
                <Link className="dropdown-item" to="https://v1-2-branch.kubeflow.org"
                  >v1.2</Link
                >
                <Link className="dropdown-item" to="https://v1-1-branch.kubeflow.org"
                  >v1.1</Link
                >
                <Link className="dropdown-item" to="https://v1-0-branch.kubeflow.org"
                  >v1.0</Link
                >
        ...
        <div className="row flex-xl-nowrap">
              ...
              >
                <ul className="td-sidebar-nav__section pr-md-3 ul-0">
                  ...
                  >
                    <Link
                      to="/docs/"
                      className="align-left pl-0 active td-sidebar-link td-sidebar-link__section tree-root"
                      id="m-docs"
                          ...
                          >
                            ...
                            <label htmlFor="m-docsaboutstyle-guide-check"
                              ><Link
                                ...
                                ><span>Documentation Style Guide</span></Link
                              ></label
                            >
                          </li>
                        </ul>
                      ...
                      >
                        ...
                        <label htmlFor="m-docsstarted-check"
                          ><Link
                            ...
                            className="align-left pl-0 td-sidebar-link td-sidebar-link__section"
                            id="m-docsstarted"
                            ><span>Getting Started</span></Link
                          ></label
                        >
                        <ul className="ul-2 foldable">
                          <li
                          ...
                          >
                            ...
                            <label htmlFor="m-docsstartedinstalling-kubeflow-check"
                              ><Link
                                ...
                                ><span>Installing Kubeflow</span></Link
                              ></label
                            >
                          </li>
                          <li
                          ...
                          >
                            ...
                            <label htmlFor="m-docscomponentscentral-dash-check"
                              ><Link
                                ...
                                ><span>Central Dashboard</span></Link
                              ></label
                            >
                            <ul className="ul-3 foldable">
                              ...
                              >
                                ...
                                />
                                <label
                                  htmlFor="m-docscomponentscentral-dashoverview-check"
                                  ><Link
                              ...
                              >
                                ...
                                />
                                <label
                                  htmlFor="m-docscomponentscentral-dashcustomizing-menu-check"
                                  ><Link
                                    to="/docs/components/central-dash/customizing-menu/"
                                    className="align-left pl-0 td-sidebar-link td-sidebar-link__page"
                                    id="m-docscomponentscentral-dashcustomizing-menu"
                                    ><span>Customizing menu items</span></Link
                                  ></label
                                >
                              </li>
                              <li
                          ...
                          >
                            ...
                            <label htmlFor="m-docscomponentsnotebooks-check"
                              ><Link
                                ...
                                ><span>Kubeflow Notebooks</span></Link
                              ></label
                            >
                            <ul className="ul-3 foldable">
                              <li
                              ...
                              >
                                ...
                                />
                                <label
                                  htmlFor="m-docscomponentsnotebooksoverview-check"
                                  ><Link
                              ...
                              >
                                ...
                                />
                                <label
                                  htmlFor="m-docscomponentsnotebookssubmit-kubernetes-check"
                                  ><Link
                                    to="/docs/components/notebooks/submit-kubernetes/"
                                    className="align-left pl-0 td-sidebar-link td-sidebar-link__page"
                                    id="m-docscomponentsnotebookssubmit-kubernetes"
                                    ><span>Submit Kubernetes Resources</span></Link
                                  ></label
                                >
                              </li>
                              <li
                          ...
                          >
                            ...
                            <label htmlFor="m-docscomponentspipelines-check"
                              ><Link
                                ...
                                ><span>Kubeflow Pipelines</span></Link
                              ></label
                            >
                            <ul className="ul-3 foldable">
                              <li
                              ...
                              >
                                ...
                                />
                                <label
                                  htmlFor="m-docscomponentspipelinesintroduction-check"
                                  ><Link
                              ...
                              >
                                ...
                                />
                                <label
                                  htmlFor="m-docscomponentspipelinesoverview-check"
                                  ><Link
                              ...
                              >
                                ...
                                <ul className="ul-4 foldable">
                                  ...
                                  >
                                    ...
                                    />
                                    <label
                                      htmlFor="m-docscomponentspipelinesconceptsrun-check"
                                      ><Link
                                        to="/docs/components/pipelines/concepts/run/"
                                        className="align-left pl-0 td-sidebar-link td-sidebar-link__page"
                                        id="m-docscomponentspipelinesconceptsrun"
                                        ><span>Run and Recurring Run</span></Link
                                      ></label
                                    >
                                  </li>
                                  <li
                                  ...
                                  >
                                    ...
                                    />
                                    <label
                                      htmlFor="m-docscomponentspipelinesconceptsstep-check"
                                      ><Link
                              ...
                              >
                                ...
                                <ul className="ul-4 foldable">
                                  ...
                                  >
                                    ...
                                    />
                                    <label
                                      htmlFor="m-docscomponentspipelinesinstallationlocalcluster-deployment-check"
                                      ><Link
                                        ...
                                        ><span>Local Deployment</span></Link
                                      ></label
                                    >
                                  </li>
                                  <li
                                  ...
                                  >
                                    ...
                                    />
                                    <label
                                      htmlFor="m-docscomponentspipelinesinstallationstandalone-deployment-check"
                                      ><Link
                                        ...
                                        ><span>Standalone Deployment</span></Link
                                      ></label
                                    >
                                  </li>
                                  <li
                                  ...
                                  >
                                    ...
                                    />
                                    <label
                                      htmlFor="m-docscomponentspipelinesinstallationcompatibility-matrix-check"
                                      ><Link
                                        ...
                                        ><span>Compatibility Matrix</span></Link
                                      ></label
                                    >
                                  </li>
                                </ul>
                              ...
                              >
                                ...
                                <ul className="ul-4 foldable">
                                  ...
                                  >
                                    ...
                                    />
                                    <label
                                      htmlFor="m-docscomponentspipelinessdksdk-overview-check"
                                      ><Link
                                  ...
                                  >
                                    ...
                                    />
                                    <label
                                      htmlFor="m-docscomponentspipelinessdkinstall-sdk-check"
                                      ><Link
                                  ...
                                  >
                                    ...
                                    />
                                    <label
                                      htmlFor="m-docscomponentspipelinessdkconnect-api-check"
                                      ><Link
                                  ...
                                  >
                                    ...
                                    />
                                    <label
                                      htmlFor="m-docscomponentspipelinessdkpython-function-components-check"
                                      ><Link
                                  ...
                                  >
                                    ...
                                    />
                                    <label
                                      htmlFor="m-docscomponentspipelinessdkbest-practices-check"
                                      ><Link
                                  ...
                                  >
                                    ...
                                    />
                                    <label
                                      htmlFor="m-docscomponentspipelinessdkparameters-check"
                                      ><Link
                                        to="/docs/components/pipelines/sdk/parameters/"
                                        className="align-left pl-0 td-sidebar-link td-sidebar-link__page"
                                        id="m-docscomponentspipelinessdkparameters"
                                        ><span>Pipeline Parameters</span></Link
                                      ></label
                                    >
                                  </li>
                                  <li
                                  ...
                                  >
                                    ...
                                    />
                                    <label
                                      htmlFor="m-docscomponentspipelinessdkoutput-viewer-check"
                                      ><Link
                                  ...
                                  >
                                    ...
                                    />
                                    <label
                                      htmlFor="m-docscomponentspipelinessdkenviroment_variables-check"
                                      ><Link
                                  ...
                                  >
                                    ...
                                    />
                                    <label
                                      htmlFor="m-docscomponentspipelinessdkgcp-check"
                                      ><Link
                                        to="/docs/components/pipelines/sdk/gcp/"
                                        className="align-left pl-0 td-sidebar-link td-sidebar-link__page"
                                        id="m-docscomponentspipelinessdkgcp"
                                        ><span
                                          >GCP-specific Uses of the SDK</span
                                        ></Link
                                      ></label
                                    >
                                  </li>
                                  ...
                                  >
                                    ...
                                    />
                                    <label
                                      htmlFor="m-docscomponentspipelinessdkmanipulate-resources-check"
                                      ><Link
                                  ...
                                  >
                                    ...
                                    />
                                    <label
                                      htmlFor="m-docscomponentspipelinessdkpython-based-visualizations-check"
                                      ><Link
                                  ...
                                  >
                                    ...
                                    />
                                    <label
                                      htmlFor="m-docscomponentspipelinessdkowners-check"
                                      ><Link
                              ...
                              >
                                ...
                                />
                                <label
                                  htmlFor="m-docscomponentspipelinessdk-v2-check"
                                  ><Link
                                    to="/docs/components/pipelines/sdk-v2/"
                                    className="align-left pl-0 td-sidebar-link td-sidebar-link__section"
                                    id="m-docscomponentspipelinessdk-v2"
                                    ><span>Pipelines SDK (v2)</span></Link
                                  ></label
                                >
                                <ul className="ul-4 foldable">
                                  <li
                                  ...
                                  >
                                    ...
                                    />
                                    <label
                                      htmlFor="m-docscomponentspipelinessdk-v2v2-compatibility-check"
                                      ><Link
                                  ...
                                  >
                                    ...
                                    />
                                    <label
                                      htmlFor="m-docscomponentspipelinessdk-v2build-pipeline-check"
                                      ><Link
                                  ...
                                  >
                                    ...
                                    />
                                    <label
                                      htmlFor="m-docscomponentspipelinessdk-v2component-development-check"
                                      ><Link
                                  ...
                                  >
                                    ...
                                    />
                                    <label
                                      htmlFor="m-docscomponentspipelinessdk-v2python-function-components-check"
                                      ><Link
                              ...
                              >
                                ...
                                />
                                <label
                                  htmlFor="m-docscomponentspipelinestutorials-check"
                                  ><Link
                                    to="/docs/components/pipelines/tutorials/"
                                    className="align-left pl-0 td-sidebar-link td-sidebar-link__section"
                                    id="m-docscomponentspipelinestutorials"
                                    ><span>Samples and Tutorials</span></Link
                                  ></label
                                >
                                <ul className="ul-4 foldable">
                                  <li
                                  ...
                                  >
                                    ...
                                    />
                                    <label
                                      htmlFor="m-docscomponentspipelinestutorialsbenchmark-examples-check"
                                      ><Link
                                  ...
                                  >
                                    ...
                                    />
                                    <label
                                      htmlFor="m-docscomponentspipelinestutorialssdk-examples-check"
                                      ><Link
                                  ...
                                  >
                                    ...
                                    />
                                    <label
                                      htmlFor="m-docscomponentspipelinestutorialsapi-pipelines-check"
                                      ><Link
                                  ...
                                  >
                                    ...
                                    />
                                    <label
                                      htmlFor="m-docscomponentspipelinestutorialsbuild-pipeline-check"
                                      ><Link
                                  ...
                                  >
                                    ...
                                    />
                                    <label
                                      htmlFor="m-docscomponentspipelinestutorialscloud-tutorials-check"
                                      ><Link
                              ...
                              >
                                ...
                                />
                                <label
                                  htmlFor="m-docscomponentspipelinestroubleshooting-check"
                                  ><Link
                              ...
                              >
                                ...
                                <ul className="ul-4 foldable">
                                  ...
                                  >
                                    ...
                                    />
                                    <label
                                      htmlFor="m-docscomponentspipelinesreferenceapikubeflow-pipeline-api-spec-check"
                                      ><Link
                                        ...
                                        ><span>Pipelines API Reference</span></Link
                                      ></label
                                    >
                                  </li>
                                  <li
                          ...
                          >
                            ...
                            <ul className="ul-3 foldable">
                              ...
                              >
                                ...
                                <label htmlFor="m-docscomponentskatiboverview-check"
                                  ><Link
                                    ...
                                    ><span>Introduction to Katib</span></Link
                                  ></label
                                >
                              </li>
                              <li
                              ...
                              >
                                ...
                                />
                                <label
                                  htmlFor="m-docscomponentskatibhyperparameter-check"
                                  ><Link
                                    to="/docs/components/katib/hyperparameter/"
                                    className="align-left pl-0 td-sidebar-link td-sidebar-link__page"
                                    id="m-docscomponentskatibhyperparameter"
                                    ><span>Getting Started with Katib</span></Link
                                  ></label
                                >
                              </li>
                              <li
                              ...
                              >
                                ...
                                />
                                <label
                                  htmlFor="m-docscomponentskatibexperiment-check"
                                  ><Link
                                    to="/docs/components/katib/experiment/"
                                    className="align-left pl-0 td-sidebar-link td-sidebar-link__page"
                                    id="m-docscomponentskatibexperiment"
                                    ><span>Running an Experiment</span></Link
                                  ></label
                                >
                              </li>
                              <li
                              ...
                              >
                                ...
                                />
                                <label
                                  htmlFor="m-docscomponentskatibresume-experiment-check"
                                  ><Link
                                    to="/docs/components/katib/resume-experiment/"
                                    className="align-left pl-0 td-sidebar-link td-sidebar-link__page"
                                    id="m-docscomponentskatibresume-experiment"
                                    ><span>Resuming an Experiment</span></Link
                                  ></label
                                >
                              </li>
                              <li
                              ...
                              >
                                ...
                                />
                                <label
                                  htmlFor="m-docscomponentskatibtrial-template-check"
                                  ><Link
                                    to="/docs/components/katib/trial-template/"
                                    className="align-left pl-0 td-sidebar-link td-sidebar-link__page"
                                    id="m-docscomponentskatibtrial-template"
                                    ><span>Overview of Trial Templates</span></Link
                                  ></label
                                >
                              </li>
                              <li
                              ...
                              >
                                ...
                                />
                                <label
                                  htmlFor="m-docscomponentskatibearly-stopping-check"
                                  ><Link
                                    to="/docs/components/katib/early-stopping/"
                                    className="align-left pl-0 td-sidebar-link td-sidebar-link__page"
                                    id="m-docscomponentskatibearly-stopping"
                                    ><span>Using Early Stopping</span></Link
                                  ></label
                                >
                              </li>
                              <li
                              ...
                              >
                                ...
                                />
                                <label
                                  htmlFor="m-docscomponentskatibkatib-config-check"
                                  ><Link
                                    to="/docs/components/katib/katib-config/"
                                    className="align-left pl-0 td-sidebar-link td-sidebar-link__page"
                                    id="m-docscomponentskatibkatib-config"
                                    ><span
                                      >Katib Configuration Overview</span
                                    ></Link
                                  ></label
                                >
                              </li>
                              ...
                              >
                                ...
                                />
                                <label
                                  htmlFor="m-docscomponentskatibenv-variables-check"
                                  ><Link
                          ...
                          >
                            ...
                            <label htmlFor="m-docscomponentstraining-check"
                              ><Link
                                ...
                                ><span>Training Operators</span></Link
                              ></label
                            >
                            <ul className="ul-3 foldable">
                              <li
                              ...
                              >
                                ...
                                />
                                <label
                                  htmlFor="m-docscomponentstrainingtftraining-check"
                                  ><Link
                                    to="/docs/components/training/tftraining/"
                                    className="align-left pl-0 td-sidebar-link td-sidebar-link__page"
                                    id="m-docscomponentstrainingtftraining"
                                    ><span>TensorFlow Training (TFJob)</span></Link
                                  ></label
                                >
                              </li>
                              <li
                              ...
                              >
                                ...
                                />
                                <label
                                  htmlFor="m-docscomponentstrainingpytorch-check"
                                  ><Link
                                    to="/docs/components/training/pytorch/"
                                    className="align-left pl-0 td-sidebar-link td-sidebar-link__page"
                                    id="m-docscomponentstrainingpytorch"
                                    ><span
                                      >PyTorch Training (PyTorchJob)</span
                                    ></Link
                                  ></label
                                >
                              </li>
                              ...
                              >
                                ...
                                <label htmlFor="m-docscomponentstrainingmxnet-check"
                                  ><Link
                                    ...
                                    ><span>MXNet Training (MXJob)</span></Link
                                  ></label
                                >
                              </li>
                              <li
                              ...
                              >
                                ...
                                />
                                <label
                                  htmlFor="m-docscomponentstrainingxgboost-check"
                                  ><Link
                                    to="/docs/components/training/xgboost/"
                                    className="align-left pl-0 td-sidebar-link td-sidebar-link__page"
                                    id="m-docscomponentstrainingxgboost"
                                    ><span
                                      >XGBoost Training (XGBoostJob)</span
                                    ></Link
                                  ></label
                                >
                              </li>
                              ...
                              >
                                ...
                                <label htmlFor="m-docscomponentstrainingmpi-check"
                                  ><Link
                                    ...
                                    ><span>MPI Training (MPIJob)</span></Link
                                  ></label
                                >
                              </li>
                              <li
                          ...
                          >
                            ...
                            <ul className="ul-3 foldable">
                              ...
                              >
                                ...
                                />
                                <label
                                  htmlFor="m-docscomponentsmulti-tenancyoverview-check"
                                  ><Link
                              ...
                              >
                                ...
                                />
                                <label
                                  htmlFor="m-docscomponentsmulti-tenancydesign-check"
                                  ><Link
                                    to="/docs/components/multi-tenancy/design/"
                                    className="align-left pl-0 td-sidebar-link td-sidebar-link__page"
                                    id="m-docscomponentsmulti-tenancydesign"
                                    ><span
                                      >Design for Multi-user Isolation</span
                                    ></Link
                                  ></label
                                >
                              </li>
                              ...
                              >
                                ...
                                />
                                <label
                                  htmlFor="m-docscomponentsmulti-tenancygetting-started-check"
                                  ><Link
                      ...
                      >
                        ...
                        <label htmlFor="m-docsexternal-add-ons-check"
                          ><Link
                            ...
                            ><span>External Add-Ons</span></Link
                          ></label
                        >
                        <ul className="ul-2 foldable">
                          <li
                          ...
                          >
                            ...
                            <ul className="ul-3 foldable">
                              ...
                              >
                                ...
                                />
                                <label
                                  htmlFor="m-docsexternal-add-onsistioistio-in-kubeflow-check"
                                  ><Link
                                    to="/docs/external-add-ons/istio/istio-in-kubeflow/"
                                    className="align-left pl-0 td-sidebar-link td-sidebar-link__page"
                                    id="m-docsexternal-add-onsistioistio-in-kubeflow"
                                    ><span>Istio Usage in Kubeflow</span></Link
                                  ></label
                                >
                              </li>
                            </ul>
                          ...
                          >
                            ...
                            <ul className="ul-3 foldable">
                              ...
                              >
                                ...
                                />
                                <label
                                  htmlFor="m-docsexternal-add-onskservekserve-check"
                                  ><Link
                          ...
                          >
                            ...
                            <ul className="ul-3 foldable">
                              ...
                              >
                                ...
                                />
                                <label
                                  htmlFor="m-docsexternal-add-onsfairinginstall-fairing-check"
                                  ><Link
                                    to="/docs/external-add-ons/fairing/install-fairing/"
                                    className="align-left pl-0 td-sidebar-link td-sidebar-link__page"
                                    id="m-docsexternal-add-onsfairinginstall-fairing"
                                    ><span>Install Kubeflow Fairing</span></Link
                                  ></label
                                >
                              </li>
                              <li
                              ...
                              >
                                ...
                                />
                                <label
                                  htmlFor="m-docsexternal-add-onsfairingconfigure-fairing-check"
                                  ><Link
                                    to="/docs/external-add-ons/fairing/configure-fairing/"
                                    className="align-left pl-0 td-sidebar-link td-sidebar-link__page"
                                    id="m-docsexternal-add-onsfairingconfigure-fairing"
                                    ><span>Configure Kubeflow Fairing</span></Link
                                  ></label
                                >
                              </li>
                              <li
                              ...
                              >
                                ...
                                />
                                <label
                                  htmlFor="m-docsexternal-add-onsfairingazure-check"
                                  ><Link
                                    to="/docs/external-add-ons/fairing/azure/"
                                    className="align-left pl-0 td-sidebar-link td-sidebar-link__section"
                                    id="m-docsexternal-add-onsfairingazure"
                                    ><span>Fairing on Azure</span></Link
                                  ></label
                                >
                              </li>
                              <li
                              ...
                              >
                                ...
                                />
                                <label
                                  htmlFor="m-docsexternal-add-onsfairinggcp-check"
                                  ><Link
                                    to="/docs/external-add-ons/fairing/gcp/"
                                    className="align-left pl-0 td-sidebar-link td-sidebar-link__section"
                                    id="m-docsexternal-add-onsfairinggcp"
                                    ><span>Fairing on GCP</span></Link
                                  ></label
                                >
                                <ul className="ul-4 foldable">
                                  <li
                                  ...
                                  >
                                    ...
                                    />
                                    <label
                                      htmlFor="m-docsexternal-add-onsfairinggcpconfigure-gcp-check"
                                      ><Link
                                  ...
                                  >
                                    ...
                                    <ul className="ul-5 foldable">
                                      ...
                                      >
                                        ...
                                        />
                                        <label
                                          htmlFor="m-docsexternal-add-onsfairinggcptutorialsgcp-local-notebook-check"
                                          ><Link
                                      ...
                                      >
                                        ...
                                        />
                                        <label
                                          htmlFor="m-docsexternal-add-onsfairinggcptutorialsgcp-kubeflow-notebook-check"
                                          ><Link
                              ...
                              >
                                ...
                                />
                                <label
                                  htmlFor="m-docsexternal-add-onsfairingreference-check"
                                  ><Link
                                ...
                                <ul className="ul-4 foldable">
                                  ...
                                  >
                                    ...
                                    />
                                    <label
                                      htmlFor="m-docsexternal-add-onsfairingreferencesdk-check"
                                      ><Link
                                        to="/docs/external-add-ons/fairing/reference/sdk/"
                                        className="align-left pl-0 td-sidebar-link td-sidebar-link__page"
                                        id="m-docsexternal-add-onsfairingreferencesdk"
                                        ><span>
                                          Kubeflow Fairing SDK Reference</span
                                        ></Link
                                      ></label
                                    >
                                  </li>
                          ...
                          >
                            ...
                            />
                            <label
                              htmlFor="m-docsexternal-add-onsfeature-store-check"
                              ><Link
                                to="/docs/external-add-ons/feature-store/"
                                className="align-left pl-0 td-sidebar-link td-sidebar-link__section"
                                id="m-docsexternal-add-onsfeature-store"
                                ><span>Feature Store</span></Link
                              ></label
                            >
                            <ul className="ul-3 foldable">
                              <li
                              ...
                              >
                                ...
                                />
                                <label
                                  htmlFor="m-docsexternal-add-onsfeature-storeoverview-check"
                                  ><Link
                                    to="/docs/external-add-ons/feature-store/overview/"
                                    className="align-left pl-0 td-sidebar-link td-sidebar-link__page"
                                    id="m-docsexternal-add-onsfeature-storeoverview"
                                    ><span>Introduction to Feast</span></Link
                                  ></label
                                >
                              </li>
                              <li
                          ...
                          >
                            ...
                            <label htmlFor="m-docsexternal-add-onsserving-check"
                              ><Link
                                ...
                                ><span>Tools for Serving</span></Link
                              ></label
                            >
                            <ul className="ul-3 foldable">
                              <li
                              ...
                              >
                                ...
                                />
                                <label
                                  htmlFor="m-docsexternal-add-onsservingoverview-check"
                                  ><Link
                              ...
                              >
                                ...
                                />
                                <label
                                  htmlFor="m-docsexternal-add-onsservingseldon-check"
                                  ><Link
                                    to="/docs/external-add-ons/serving/seldon/"
                                    className="align-left pl-0 td-sidebar-link td-sidebar-link__page"
                                    id="m-docsexternal-add-onsservingseldon"
                                    ><span>Seldon Core Serving</span></Link
                                  ></label
                                >
                              </li>
                              <li
                              ...
                              >
                                ...
                                />
                                <label
                                  htmlFor="m-docsexternal-add-onsservingmlrun-check"
                                  ><Link
                                    to="/docs/external-add-ons/serving/mlrun/"
                                    className="align-left pl-0 td-sidebar-link td-sidebar-link__page"
                                    id="m-docsexternal-add-onsservingmlrun"
                                    ><span>MLRun Serving Pipelines</span></Link
                                  ></label
                                >
                              </li>
                              <li
                              ...
                              >
                                ...
                                />
                                <label
                                  htmlFor="m-docsexternal-add-onsservingtfbatchpredict-check"
                                  ><Link
                                    to="/docs/external-add-ons/serving/tfbatchpredict/"
                                    className="align-left pl-0 td-sidebar-link td-sidebar-link__page"
                                    id="m-docsexternal-add-onsservingtfbatchpredict"
                                    ><span>TensorFlow Batch Prediction</span></Link
                                  ></label
                                >
                              </li>
                            </ul>
                          ...
                          >
                            ...
                            <label htmlFor="m-docsdistributionsaws-check"
                              ><Link
                                ...
                                ><span>Kubeflow on AWS</span></Link
                              ></label
                            >
                          </li>
                          <li
                          ...
                          >
                            ...
                            <label htmlFor="m-docsdistributionsazure-check"
                              ><Link
                                ...
                                ><span>Kubeflow on Azure</span></Link
                              ></label
                            >
                            <ul className="ul-3 foldable">
                              <li
                              ...
                              >
                                ...
                                />
                                <label
                                  htmlFor="m-docsdistributionsazuredeploy-check"
                                  ><Link
                                    to="/docs/distributions/azure/deploy/"
                                    className="align-left pl-0 td-sidebar-link td-sidebar-link__section"
                                    id="m-docsdistributionsazuredeploy"
                                    ><span>Deployment</span></Link
                                  ></label
                                >
                                <ul className="ul-4 foldable">
                                  <li
                                  ...
                                  >
                                    ...
                                    />
                                    <label
                                      htmlFor="m-docsdistributionsazuredeployexisting-cluster-check"
                                      ><Link
                              ...
                              >
                                ...
                                />
                                <label
                                  htmlFor="m-docsdistributionsazureauthentication-oidc-check"
                                  ><Link
                                    to="/docs/distributions/azure/authentication-oidc/"
                                    className="align-left pl-0 td-sidebar-link td-sidebar-link__page"
                                    id="m-docsdistributionsazureauthentication-oidc"
                                    ><span
                                      >Authentication using OIDC in Azure</span
                                    ></Link
                                  ></label
                                >
                              </li>
                              ...
                              >
                                ...
                                />
                                <label
                                  htmlFor="m-docsdistributionsazureazureendtoend-check"
                                  ><Link
                                    to="/docs/distributions/azure/azureendtoend/"
                                    className="align-left pl-0 td-sidebar-link td-sidebar-link__page"
                                    id="m-docsdistributionsazureazureendtoend"
                                    ><span
                                      >End-to-End Pipeline Example on
                                      Azure</span
                                    ></Link
                                  ></label
                                >
                              ...
                              >
                                ...
                                />
                                <label
                                  htmlFor="m-docsdistributionsazureauthentication-check"
                                  ><Link
                                    to="/docs/distributions/azure/authentication/"
                                    className="align-left pl-0 td-sidebar-link td-sidebar-link__page"
                                    id="m-docsdistributionsazureauthentication"
                                    ><span
                                      >Access Control for Azure Deployment</span
                                    ></Link
                                  ></label
                                >
                              </li>
                              ...
                              >
                                ...
                                />
                                <label
                                  htmlFor="m-docsdistributionsazureazuremysql-check"
                                  ><Link
                          ...
                          >
                            ...
                            <label htmlFor="m-docsdistributionsgke-check"
                              ><Link
                                ...
                                ><span>Kubeflow on Google Cloud</span></Link
                              ></label
                            >
                            <ul className="ul-3 foldable">
                              <li
                              ...
                              >
                                ...
                                <ul className="ul-4 foldable">
                                  ...
                                  >
                                    ...
                                    />
                                    <label
                                      htmlFor="m-docsdistributionsgkedeployoverview-check"
                                      ><Link
                                  ...
                                  >
                                    ...
                                    />
                                    <label
                                      htmlFor="m-docsdistributionsgkedeployoauth-setup-check"
                                      ><Link
                                        to="/docs/distributions/gke/deploy/oauth-setup/"
                                        className="align-left pl-0 td-sidebar-link td-sidebar-link__page"
                                        id="m-docsdistributionsgkedeployoauth-setup"
                                        ><span>Set up OAuth client</span></Link
                                      ></label
                                    >
                                  </li>
                                  <li
                                  ...
                                  >
                                    ...
                                    />
                                    <label
                                      htmlFor="m-docsdistributionsgkedeploydeploy-cli-check"
                                      ><Link
                                        to="/docs/distributions/gke/deploy/deploy-cli/"
                                        className="align-left pl-0 td-sidebar-link td-sidebar-link__page"
                                        id="m-docsdistributionsgkedeploydeploy-cli"
                                        ><span>Deploy Kubeflow cluster</span></Link
                                      ></label
                                    >
                                  </li>
                                  <li
                                  ...
                                  >
                                    ...
                                    />
                                    <label
                                      htmlFor="m-docsdistributionsgkedeployupgrade-check"
                                      ><Link
                                        to="/docs/distributions/gke/deploy/upgrade/"
                                        className="align-left pl-0 td-sidebar-link td-sidebar-link__page"
                                        id="m-docsdistributionsgkedeployupgrade"
                                        ><span>Upgrade Kubeflow</span></Link
                                      ></label
                                    >
                                  </li>
                                  <li
                              ...
                              >
                                ...
                                />
                                <label
                                  htmlFor="m-docsdistributionsgkepipelines-check"
                                  ><Link
                                    to="/docs/distributions/gke/pipelines/"
                                    className="align-left pl-0 td-sidebar-link td-sidebar-link__section"
                                    id="m-docsdistributionsgkepipelines"
                                    ><span>Pipelines on Google Cloud</span></Link
                                  ></label
                                >
                                <ul className="ul-4 foldable">
                                  <li
                                  ...
                                  >
                                    ...
                                    />
                                    <label
                                      htmlFor="m-docsdistributionsgkepipelinesauthentication-sdk-check"
                                      ><Link
                                        ...
                                        ><span
                                          ...
                                          Google Cloud using the SDK</span
                                        ></Link
                                      ></label
                                    >
                                  </li>
                                  ...
                                  >
                                    ...
                                    />
                                    <label
                                      htmlFor="m-docsdistributionsgkepipelinesauthentication-pipelines-check"
                                      ><Link
                                  ...
                                  >
                                    ...
                                    />
                                    <label
                                      htmlFor="m-docsdistributionsgkepipelinespreemptible-check"
                                      ><Link
                              ...
                              >
                                ...
                                />
                                <label
                                  htmlFor="m-docsdistributionsgkecustomizing-gke-check"
                                  ><Link
                                    to="/docs/distributions/gke/customizing-gke/"
                                    className="align-left pl-0 td-sidebar-link td-sidebar-link__page"
                                    id="m-docsdistributionsgkecustomizing-gke"
                                    ><span>Customize Kubeflow on GKE</span></Link
                                  ></label
                                >
                              </li>
                              <li
                              ...
                              >
                                ...
                                />
                                <label
                                  htmlFor="m-docsdistributionsgkecustom-domain-check"
                                  ><Link
                                    to="/docs/distributions/gke/custom-domain/"
                                    className="align-left pl-0 td-sidebar-link td-sidebar-link__page"
                                    id="m-docsdistributionsgkecustom-domain"
                                    ><span>Using Your Own Domain</span></Link
                                  ></label
                                >
                              </li>
                              <li
                              ...
                              >
                                ...
                                />
                                <label
                                  htmlFor="m-docsdistributionsgkeauthentication-check"
                                  ><Link
                                    to="/docs/distributions/gke/authentication/"
                                    className="align-left pl-0 td-sidebar-link td-sidebar-link__page"
                                    id="m-docsdistributionsgkeauthentication"
                                    ><span
                                      >Authenticating Kubeflow to Google
                                      Cloud</span
                                    ></Link
                                  ></label
                                >
                              ...
                              >
                                ...
                                />
                                <label
                                  htmlFor="m-docsdistributionsgkeprivate-clusters-check"
                                  ><Link
                                    to="/docs/distributions/gke/private-clusters/"
                                    className="align-left pl-0 td-sidebar-link td-sidebar-link__page"
                                    id="m-docsdistributionsgkeprivate-clusters"
                                    ><span>Securing Your Clusters</span></Link
                                  ></label
                                >
                              </li>
                              <li
                              ...
                              >
                                ...
                                />
                                <label
                                  htmlFor="m-docsdistributionsgketroubleshooting-gke-check"
                                  ><Link
                                    to="/docs/distributions/gke/troubleshooting-gke/"
                                    className="align-left pl-0 td-sidebar-link td-sidebar-link__page"
                                    id="m-docsdistributionsgketroubleshooting-gke"
                                    ><span
                                      >Troubleshooting Deployments on GKE</span
                                    ></Link
                                  ></label
                                >
                              </li>
                              ...
                              >
                                ...
                                <label htmlFor="m-docsdistributionsgkeanthos-check"
                                  ><Link
                                    ...
                                    ><span
                                      >Kubeflow On-premises on Anthos</span
                                    ></Link
                                  ></label
                                >
                              </li>
                          ...
                          >
                            ...
                            <label htmlFor="m-docsdistributionsibm-check"
                              ><Link
                                ...
                                ><span>Kubeflow on IBM Cloud</span></Link
                              ></label
                            >
                            <ul className="ul-3 foldable">
                              <li
                              ...
                              >
                                ...
                                />
                                <label
                                  htmlFor="m-docsdistributionsibmcreate-cluster-check"
                                  ><Link
                              ...
                              >
                                ...
                                />
                                <label
                                  htmlFor="m-docsdistributionsibmcreate-cluster-vpc-check"
                                  ><Link
                              ...
                              >
                                ...
                                <label htmlFor="m-docsdistributionsibmdeploy-check"
                                  ><Link
                                    ...
                                    ><span
                                      >Kubeflow Deployment on IBM Cloud</span
                                    ></Link
                                  ></label
                                >
                                <ul className="ul-4 foldable">
                                  ...
                                  >
                                    ...
                                    />
                                    <label
                                      htmlFor="m-docsdistributionsibmdeployiks-compatibility-check"
                                      ><Link
                                  ...
                                  >
                                    ...
                                    />
                                    <label
                                      htmlFor="m-docsdistributionsibmdeployinstall-kubeflow-on-ibm-openshift-check"
                                      ><Link
                                        ...
                                        ><span
                                          >Install Kubeflow on OpenShift</span
                                        ></Link
                                      ></label
                                    >
                                  </li>
                                  ...
                                  >
                                    ...
                                    />
                                    <label
                                      htmlFor="m-docsdistributionsibmdeployauthentication-check"
                                      ><Link
                                  ...
                                  >
                                    ...
                                    />
                                    <label
                                      htmlFor="m-docsdistributionsibmdeployuninstall-kubeflow-check"
                                      ><Link
                              ...
                              >
                                ...
                                />
                                <label
                                  htmlFor="m-docsdistributionsibmpipelines-check"
                                  ><Link
                                    to="/docs/distributions/ibm/pipelines/"
                                    className="align-left pl-0 td-sidebar-link td-sidebar-link__page"
                                    id="m-docsdistributionsibmpipelines"
                                    ><span
                                      >Pipelines on IBM Cloud Kubernetes Service
                                      (IKS)</span
                                    ></Link
                                  ></label
                                >
                              ...
                              >
                                ...
                                />
                                <label
                                  htmlFor="m-docsdistributionsibmusing-icr-check"
                                  ><Link
                              ...
                              >
                                ...
                                <label htmlFor="m-docsdistributionsibmiks-e2e-check"
                                  ><Link
                                    ...
                                    ><span
                                      >End-to-end Kubeflow on IBM Cloud</span
                                    ></Link
                                  ></label
                                >
                              </li>
                          ...
                          >
                            ...
                            <label htmlFor="m-docsdistributionsnutanix-check"
                              ><Link
                                ...
                                ><span>Kubeflow on Nutanix Karbon</span></Link
                              ></label
                            >
                            <ul className="ul-3 foldable">
                              <li
                              ...
                              >
                                ...
                                />
                                <label
                                  htmlFor="m-docsdistributionsnutanixinstall-kubeflow-check"
                                  ><Link
                                    to="/docs/distributions/nutanix/install-kubeflow/"
                                    className="align-left pl-0 td-sidebar-link td-sidebar-link__page"
                                    id="m-docsdistributionsnutanixinstall-kubeflow"
                                    ><span
                                      >Install Kubeflow on Nutanix Karbon</span
                                    ></Link
                                  ></label
                                >
                              </li>
                              ...
                              >
                                ...
                                />
                                <label
                                  htmlFor="m-docsdistributionsnutanixnutanix-storage-check"
                                  ><Link
                                    to="/docs/distributions/nutanix/nutanix-storage/"
                                    className="align-left pl-0 td-sidebar-link td-sidebar-link__page"
                                    id="m-docsdistributionsnutanixnutanix-storage"
                                    ><span
                                      >Integrate with Nutanix Storage</span
                                    ></Link
                                  ></label
                                >
                              </li>
                              ...
                              >
                                ...
                                />
                                <label
                                  htmlFor="m-docsdistributionsnutanixuninstall-kubeflow-check"
                                  ><Link
                          ...
                          >
                            ...
                            <label htmlFor="m-docsdistributionsekf-check"
                              ><Link
                                ...
                                ><span>Arrikto Enterprise Kubeflow</span></Link
                              ></label
                            >
                          </li>
                          <li
                          ...
                          >
                            ...
                            <ul className="ul-3 foldable">
                              ...
                              >
                                ...
                                />
                                <label
                                  htmlFor="m-docsdistributionsminikfminikf-aws-check"
                                  ><Link
                                    to="/docs/distributions/minikf/minikf-aws/"
                                    className="align-left pl-0 td-sidebar-link td-sidebar-link__page"
                                    id="m-docsdistributionsminikfminikf-aws"
                                    ><span>MiniKF on AWS Marketplace</span></Link
                                  ></label
                                >
                              </li>
                              <li
                              ...
                              >
                                ...
                                />
                                <label
                                  htmlFor="m-docsdistributionsminikfminikf-gcp-check"
                                  ><Link
                                    to="/docs/distributions/minikf/minikf-gcp/"
                                    className="align-left pl-0 td-sidebar-link td-sidebar-link__page"
                                    id="m-docsdistributionsminikfminikf-gcp"
                                    ><span>MiniKF on GCP Marketplace</span></Link
                                  ></label
                                >
                              </li>
                            </ul>
                          ...
                          >
                            ...
                            <label htmlFor="m-docsdistributionscharmed-check"
                              ><Link
                                ...
                                ><span>Charmed Kubeflow</span></Link
                              ></label
                            >
                            <ul className="ul-3 foldable">
                              <li
                              ...
                              >
                                ...
                                />
                                <label
                                  htmlFor="m-docsdistributionscharmedinstall-kubeflow-check"
                                  ><Link
                                    to="/docs/distributions/charmed/install-kubeflow/"
                                    className="align-left pl-0 td-sidebar-link td-sidebar-link__page"
                                    id="m-docsdistributionscharmedinstall-kubeflow"
                                    ><span
                                      >Charmed Kubeflow deployment guide</span
                                    ></Link
                                  ></label
                                >
                              </li>
                          ...
                          >
                            ...
                            <label htmlFor="m-docsdistributionsoperator-check"
                              ><Link
                                ...
                                ><span>Kubeflow Operator</span></Link
                              ></label
                            >
                            <ul className="ul-3 foldable">
                              <li
                              ...
                              >
                                ...
                                />
                                <label
                                  htmlFor="m-docsdistributionsoperatorintroduction-check"
                                  ><Link
                              ...
                              >
                                ...
                                />
                                <label
                                  htmlFor="m-docsdistributionsoperatorinstall-kubeflow-check"
                                  ><Link
                              ...
                              >
                                ...
                                />
                                <label
                                  htmlFor="m-docsdistributionsoperatortroubleshooting-check"
                                  ><Link
                          ...
                          >
                            ...
                            <label htmlFor="m-docsdistributionsopenshift-check"
                              ><Link
                                ...
                                ><span>Kubeflow on OpenShift</span></Link
                              ></label
                            >
                            <ul className="ul-3 foldable">
                              <li
                              ...
                              >
                                ...
                                />
                                <label
                                  htmlFor="m-docsdistributionsopenshiftinstall-kubeflow-check"
                                  ><Link
                              ...
                              >
                                ...
                                />
                                <label
                                  htmlFor="m-docsdistributionsopenshiftuninstall-kubeflow-check"
                                  ><Link
          ...
          <aside className="d-none d-xl-block col-xl-2 td-sidebar-toc d-print-none">
            <div className="td-page-meta ml-2 pb-1 pt-2 mb-0">
              <Link
                to="https://github.com/kubeflow/website/tree/master/content/en/docs/_index.md"
                className="td-page-meta--view"
                target="_blank"
                rel="noopener"
                ><i className="fa fa-file-alt fa-fw"></i> View page source</Link
              >
              <Link
                to="https://github.com/kubeflow/website/edit/master/content/en/docs/_index.md"
                className="td-page-meta--edit"
                target="_blank"
                rel="noopener"
                ><i className="fa fa-edit fa-fw"></i> Edit this page</Link
              >
              <Link
                to="https://github.com/kubeflow/website/new/master/content/en/docs/_index.md?filename=change-me.md&amp;value=---%0Atitle%3A+%22Long+Page+Title%22%0AlinkTitle%3A+%22Short+Nav+Title%22%0Aweight%3A+100%0Adescription%3A+%3E-%0A+++++Page+description+for+heading+and+indexes.%0A---%0A%0A%23%23+Heading%0A%0AEdit+this+template+to+create+your+new+page.%0A%0A%2A+Give+it+a+good+name%2C+ending+in+%60.md%60+-+e.g.+%60getting-started.md%60%0A%2A+Edit+the+%22front+matter%22+section+at+the+top+of+the+page+%28weight+controls+how+its+ordered+amongst+other+pages+in+the+same+directory%3B+lowest+number+first%29.%0A%2A+Add+a+good+commit+message+at+the+bottom+of+the+page+%28%3C80+characters%3B+use+the+extended+description+field+for+more+detail%29.%0A%2A+Create+a+new+branch+so+you+can+preview+your+new+file+and+request+a+review+via+Pull+Request.%0A"
                className="td-page-meta--child"
                target="_blank"
                rel="noopener"
                ><i className="fa fa-edit fa-fw"></i> Create child page</Link
              >
              <Link
                to="https://github.com/kubeflow/website/issues/new?title=Documentation"
              ...
              <Link
                ...
                target="_blank"
                rel="noopener"
                ><i className="fas fa-tasks fa-fw"></i> Create project issue</Link
              >
            </div>
          </aside>
          <main className="col-12 col-md-9 col-xl-8 pl-md-5" role="main">
            <nav aria-label="breadcrumb" className="d-none d-md-block d-print-none">
            ...
            <div className="td-content">
              <h1>Documentation</h1>
              <div className="lead">All of Kubeflow documentation</div>
              ...
              <div className="section-index">
                ...
                <div className="entry">
                  ...
                  <p>About Kubeflow and its community</p>
                </div>
                <div className="entry">
                  <h5>
                    <Link to="/docs/started/">Getting Started</Link>
                  </h5>
                  <p>How to get started with Kubeflow</p>
                </div>
                <div className="entry">
                  <h5>
                    <Link to="/docs/components/">Components</Link>
                  </h5>
                  <p>Logical components that make up Kubeflow</p>
                </div>
                <div className="entry">
                  <h5>
                    <Link to="/docs/external-add-ons/">External Add-Ons</Link>
                  </h5>
                  <p>
                    Additional tools that may be integrated with a Kubeflow
                    deployment or distribution.
                  </p>
                </div>
                <div className="entry">
                  <h5>
                    <Link to="/docs/distributions/">Distributions</Link>
                  </h5>
                  <p>A list of available Kubeflow distributions</p>
                </div>
                <div className="entry">
                  <h5>
                    <Link to="/docs/releases/">Releases</Link>
                  </h5>
                  <p>Information about past and future Kubeflow releases</p>
                </div>
              </div>
                ...
                <div className="card-body">
                  ...
                  <p className="feedback--response feedback--response-yes">
                    ...
                    <Link to="https://github.com/kubeflow/website/issues/new"
                      >tell us how we can improve</Link
                    >.
                  </p>
              ...
              <div className="text-muted mt-5 pt-3 border-top">
                ...
                <Link
                  to="https://github.com/kubeflow/website/commit/d0bd0e031453d12e704d0636f9ad192c866a327c"
                  >Restructured the website repo to allow for future i18n and
                  content translation (#1909) (d0bd0e03)</Link
                >
              </div>
            </div>
          </main>
